...
var SharedOfflineLocalStorage = nil;
...
+ (RLOfflineLocalStorage)sharedOfflineLocalStorage
{
    if (!SharedOfflineLocalStorage)
        SharedOfflineLocalStorage = [[RLOfflineLocalStorage alloc] initWithName:@"default" delegate:nil];

    return SharedOfflineLocalStorage;
}
